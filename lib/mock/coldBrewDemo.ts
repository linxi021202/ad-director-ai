...
export const coldBrewDemo = generationProjectSchema.parse({
  ...
  shots: [
    {
      ...
      visualDescription: "清晨地铁口与写字楼之间，人流快速穿梭，主角从画面侧面进入，真实上传产品在前景留位区域被玻璃幕墙反光突出。",
      cameraAngle: "中景到中近景，低角度三分之二侧拍",
      cameraMovement: "稳定器跟拍推进，末尾轻微推近真实产品",
      subtitle: "早高峰，也要清醒在线。",
      imagePromptCn: appendNoReadableTextRules("9:16竖版广告关键帧，清晨一线城市通勤场景，年轻上班族经过地铁口和玻璃写字楼，前景为真实上传产品保留干净无遮挡的合成区域，冷色调科技感，高级商业摄影，城市反光，清爽克制。"),
      imagePromptEn: appendNoReadableTextRules("9:16 vertical advertising keyframe, morning commute in a tier-one city, young office worker near a reserved placement area for the real uploaded cold brew product, subway entrance and glass office buildings, cool tech mood, premium commercial photography, urban reflections, clean and refined."),
      videoPromptCn: appendNoReadableTextRules("镜头从人群侧后方稳定推进，主角进入画面并靠近前景真实产品，城市玻璃幕墙反光扫过产品区域，节奏快速但画面克制，适合抖音/小红书竖版广告开场。"),
      recommendedModel: "DeepSeek-V4-Pro生成策略/分镜/Prompt；Qwen-Image-2.0预留关键帧；Remotion完成图片动效fallback。",
    ...
    },
    {
      ...
      visualDescription: "办公桌上抽象无文字界面发出柔和冷光，真实上传产品位于画面中心，旁边是键盘、空白资料和无界面手机。",
      cameraAngle: "产品近景特写，略带俯拍",
      cameraMovement: "慢速环绕加微距推近，最后停在产品轮廓与材质",
      subtitle: "冷萃顺滑，低糖轻盈。",
      imagePromptCn: appendNoReadableTextRules("低糖冷萃咖啡产品特写背景，办公桌场景，笔记本电脑仅有抽象失焦冷光，中心保留真实上传产品合成区域，深色科技办公氛围，商业产品摄影，高级清爽，9:16竖版构图。"),
      imagePromptEn: appendNoReadableTextRules("Office desk scene with a clean reserved placement area for the real uploaded cold brew product, abstract defocused screen glow, dark tech office atmosphere, premium refreshing commercial product photography, 9:16 vertical composition."),
      videoPromptCn: appendNoReadableTextRules("镜头围绕真实产品缓慢移动，电脑屏幕只有抽象失焦冷光并在产品外观上滑过；产品几何、轮廓和包装像素不变，字幕由 Remotion 后期叠加。"),
    ...
    },
    {
      ...
      cameraMovement: "轻微缩放，无文字几何光环围绕真实产品定位",
      subtitle: "低糖 / 冷萃 / 轻负担",
      imagePromptCn: appendNoReadableTextRules("真实上传低糖冷萃咖啡产品居中展示，深色科技背景，无字符的简洁几何光环围绕产品浮现，高级广告视觉，9:16竖版，干净留白。"),
      imagePromptEn: appendNoReadableTextRules("Dark premium product-stage background with a centered clean placement area for the real uploaded cold brew product, subtle geometric light rings, no readable labels, no letters, no pseudo-text, 9:16 vertical layout, clean negative space."),
      videoPromptCn: appendNoReadableTextRules("产品居中轻微放大，一个无字符的几何光环持续环绕产品；低糖、冷萃、轻负担由 Remotion 后期叠加，背景保持克制流光和轻微粒子。"),
      recommendedModel: "DeepSeek-V4-Pro规划卖点结构与Prompt；Qwen-Image-2.0预留关键帧；Remotion合成HUD动效。",
    ...
    },
    {
      ...
      videoPromptCn: appendNoReadableTextRules("人物在城市天台自然抬起咖啡瓶，摄影机沿同一轴线连续推近，始终保持人物、城市与真实产品处于同一时空和同一全画幅画面；不改变产品包装，不生成文字，标题、口号和 CTA 由 Remotion 后期叠加。"),
      recommendedModel: "Wan 2.7 I2V 视频生成模型；Remotion完成标题、字幕和CTA合成。",
    ...
    ,
    {
      ...
      visualDescription: "真实上传产品位于前景，办公环境光线从低沉逐渐转为清透，人物仅作为虚化背景，保持产品像素与包装外观一致。",
      ...
      videoPromptCn: appendNoReadableTextRules("以当前锁定关键帧为唯一首帧，镜头缓慢推进，保持产品几何、轮廓、容器类型、包装颜色、标签像素和比例完全一致，不新增人物，不改变产品设计，所有广告文字由 Remotion 后期叠加。"),
      recommendedModel: "wan2.7-i2v",
    ...
    },
    {
      ...
      imagePromptEn: appendNoReadableTextRules("9:16 vertical advertising keyframe, focused work scene in a modern office, reserved foreground placement area for the real uploaded product forming a stable triangular composition with keyboard and blank notebook, natural hands working near a defocused abstract screen, cool premium commercial photography, clean subtitle-safe negative space."),
    ...
    },
    {
      ...
      videoPromptCn: appendNoReadableTextRules("镜头轻微推近，人物只伸手靠近前景真实产品，光线与环境色温平滑变亮，产品包装、几何、比例与构图保持一致，不生成任何文字。"),
      recommendedModel: "qwen-image-2.0",
  ...
  modelRoutes: [
    ...
    },
    {
      ...
      reason: "主视频节点使用 Wan 2.7 I2V，并只接收一张已融合真实产品的完整关键帧；其余镜头使用关键帧动效完成。",
      estimatedCost: 3,
  ...
  costEstimates: [
    {
      ...
      minCny: 8,
      maxCny: 15,
      explanation: "DeepSeek + Qwen-Image关键帧 + Wan 2.7 I2V视频节点 + Remotion。"
    },
    {
      mode: "qualityFirst",
      label: "自动化视频模式",
      minCny: 15,
      maxCny: 35,
      explanation: "DeepSeek + Qwen-Image关键帧 + Wan 2.7 I2V真实视频 + Remotion。"
    }
  ],
